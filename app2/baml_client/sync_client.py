...
class BamlSyncClient:
    ...
    def UseTool(
        ...
        user_message: str,
        baml_options: BamlCallOptions = {},
    ) -> List[Union[types.Planner, types.Add, types.Subtract, types.Divide, types.Multiply, types.Executor]]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return cast(List[Union[types.Planner, types.Add, types.Subtract, types.Divide, types.Multiply, types.Executor]], raw.cast_to(types, types, partial_types, False))
...
class BamlStreamClient:
    ...
    def UseTool(
        ...
        user_message: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[List[Optional[Union[partial_types.Planner, partial_types.Add, partial_types.Subtract, partial_types.Divide, partial_types.Multiply, partial_types.Executor]]], List[Union[types.Planner, types.Add, types.Subtract, types.Divide, types.Multiply, types.Executor]]]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlSyncStream[List[Optional[Union[partial_types.Planner, partial_types.Add, partial_types.Subtract, partial_types.Divide, partial_types.Multiply, partial_types.Executor]]], List[Union[types.Planner, types.Add, types.Subtract, types.Divide, types.Multiply, types.Executor]]](
        raw,
        lambda x: cast(List[Optional[Union[partial_types.Planner, partial_types.Add, partial_types.Subtract, partial_types.Divide, partial_types.Multiply, partial_types.Executor]]], x.cast_to(types, types, partial_types, True)),
        lambda x: cast(List[Union[types.Planner, types.Add, types.Subtract, types.Divide, types.Multiply, types.Executor]], x.cast_to(types, types, partial_types, False)),
        self.__ctx_manager.get(),
      )
