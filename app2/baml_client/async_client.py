...
class BamlStreamClient:
    ...
    def UseTool(
        ...
        user_message: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[List[Optional[Union[partial_types.Planner, partial_types.Add, partial_types.Subtract, partial_types.Divide, partial_types.Multiply, partial_types.Executor]]], List[Union[types.Planner, types.Add, types.Subtract, types.Divide, types.Multiply, types.Executor]]]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlStream[List[Optional[Union[partial_types.Planner, partial_types.Add, partial_types.Subtract, partial_types.Divide, partial_types.Multiply, partial_types.Executor]]], List[Union[types.Planner, types.Add, types.Subtract, types.Divide, types.Multiply, types.Executor]]](
        raw,
